    ...
    <section class="content container-fluid">
        <div class="box box-warning">
            <form action="" method="post" name="">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <label>
                                <input type="radio" name="rb" class="minimal-red" value="Emoney" <?php echo ($payment_type == 'Check') ? 'checked' : '' ?>>
                                Emoney
                            </label>
                        </div>
                    </div>
                ...
                <hr>
                <div align="center">
                    <input type="submit" name="btnupdateorder" value="Perbarui Order" class="btn btn-warning">
                </div>
                <hr>
            </form>
        </div>
