...
<head>
  ...
  <title>KantinTeknik | Admin</title>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <!-- Sidebar Menu -->
        <ul class="sidebar-menu" data-widget="tree" style="font-size: 17px;">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="category.php"><i class="fa fa-th-list"></i>Kategori</a></li>
              <li><a href="productlist.php"><i class="fa fa-table"></i>Daftar Produk</a></li>
            </ul>
          </li>
          <li><a href="createorder.php"><i class="fa fa-money"></i> <span>POS</span></a></li>
          <li><a href="orderlist.php"><i class="fa fa-list-ul"></i> <span>Daftar Order</span></a></li>
          <li><a href="tablereport.php"><i class="fa fa-list-ul"></i> <span>Laporan Penjualan</span></a></li>
          <li><a href="registration.php"><i class="	fa fa-drivers-license-o"></i> <span>Registrasi</span></a></li>
        </ul>
      </section>
    </aside>
